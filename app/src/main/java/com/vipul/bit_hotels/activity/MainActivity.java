...
//    private String spreadsheetId = "1Lij_q-s2LsCgbKQEx2Je2oKt_zWoDg_s0mfhB6OwZqw";
//    private String range = "Sheet1!A1:B";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child("SacramentoImage").removeValue();


        Intent i = getIntent();
        code = i.getStringExtra("code");

        if (code.equals("datamaster")) {
    ...
    private void setUpNavigationDrawer() {
        ...
        mNavigationDrawerFragment.setUp(R.id.navigation_drawer,
                (DrawerLayout) findViewById(R.id.drawer_layout), code);
    }
