...
import com.vipul.bit_hotels.adapter.CustomListAdapter;
...
public class ViewDataActivity extends AppCompatActivity {
    ...
    private ArrayList<String> teamAlliances = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomListAdapter listAdapter = new CustomListAdapter(this, R.layout.list_item, teams, teamAlliances);
...
//                }
                ...
                for (int i = 0; i < finalArr.length; i++) {
                    ...
                    teamAlliances.add(finalArr[i][1]);
                    System.out.println(teams);
                }

                CustomListAdapter listAdapter = new CustomListAdapter(getApplicationContext(), R.layout.list_item, teams, teamAlliances);
                listview.setAdapter(listAdapter);
...
//        };
        ...
        System.out.println(teams);
        System.out.println(teamAlliances);
